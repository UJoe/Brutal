...
var Rooms = [
    ...
    ["./img/zaba.jpg", "- Gyere, zabáljunk! - csalogat kedvesen egy koszos gyorsétteremben terpeszkedő muksó. Bemész?", "eat", 3],
    ...
    ["./img/vial.png", "Találsz a zsebedben egy ampullát. Rejtély, hogy hogy került oda, de ha gondolod, idd meg a tartalmát!", "potion", 7]
];
var XRooms = [
...
function ActionBtn() {
    switch (Rooms[Room][2]) {
        ...
        case "drink":
            ...
            Character[0] += x;
            alert("Jót iszol a kútból, nyersz " + x + " Erőt és felfrissülten továbbgaloppozol.");
            document.body.setAttribute("style", "filter: blur(20px) brightness(0)");
            NewRoom();
            break;
